...
<div className={`absolute bottom-[15%] md:bottom-32 z-10 text-white w-full max-w-7xl px-6 md:px-20 transition-all duration-1000 ${isRtl ? 'right-0 text-right' : 'left-0 text-left'}`}>
  ...
  {/* --- بداية تعديل الأزرار الصحيح --- */}
  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
    <Link 
      to="/properties/ajman" 
      className="w-full sm:w-auto bg-white text-black px-10 py-4 md:py-5 uppercase tracking-[0.2em] text-[9px] font-black transition-all duration-500 active:scale-95 shadow-2xl flex items-center justify-center text-center no-underline"
    >
      {t.exploreBtn}
    </Link>
